...
$.ajax({
		url: 'http://proyectosmichaelserrato.tk/jelouchat/getMsg-Science.php?getMsg=true&orderMsg=DESC&numberMsg=8',
		    dataType: "jsonp",
			...
			for(var i =1; i <= objCount; i++){
				...
				$name = $objMsg.name;
				$msg = $objMsg.msg;
				$("#allMsgPublicListView").append('<div class="list-msg"><img src="assets/jelouchat-images/JelouChat-1.0beta.jpg" class="img-perfil"><div class="container-msg"><h3>  '+$name+' </h3><p> '+$msg+' </p></div></div>');
				/*
